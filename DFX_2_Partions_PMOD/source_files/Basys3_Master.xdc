...
##Pmod Header JA
##Sch name = JA1
set_property PACKAGE_PIN J1 [get_ports {P_LEDS[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {P_LEDS[0]}]
#Sch name = JA2
set_property PACKAGE_PIN L2 [get_ports {P_LEDS[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {P_LEDS[1]}]
#Sch name = JA3
set_property PACKAGE_PIN J2 [get_ports {P_LEDS[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {P_LEDS[2]}]
#Sch name = JA4
set_property PACKAGE_PIN G2 [get_ports {P_LEDS[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {P_LEDS[3]}]
##Sch name = JA7
...
#Sch name = JA10
set_property PACKAGE_PIN G3 [get_ports MOTOR_PIN]
set_property IOSTANDARD LVCMOS33 [get_ports MOTOR_PIN]
...
create_pblock pblock_RECONFIG_PMOD
add_cells_to_pblock [get_pblocks pblock_RECONFIG_PMOD] [get_cells -quiet [list RECONFIG_PMOD]]
resize_pblock [get_pblocks pblock_RECONFIG_PMOD] -add {SLICE_X0Y60:SLICE_X13Y74}
resize_pblock [get_pblocks pblock_RECONFIG_PMOD] -add {DSP48_X0Y24:DSP48_X0Y29}
resize_pblock [get_pblocks pblock_RECONFIG_PMOD] -add {RAMB18_X0Y24:RAMB18_X0Y29}
resize_pblock [get_pblocks pblock_RECONFIG_PMOD] -add {RAMB36_X0Y12:RAMB36_X0Y14}
set_property SNAPPING_MODE ON [get_pblocks pblock_RECONFIG_PMOD]
...
resize_pblock [get_pblocks pblock_RECONFIG_LEDS] -add {SLICE_X36Y35:SLICE_X51Y49}
resize_pblock [get_pblocks pblock_RECONFIG_LEDS] -add {RAMB18_X1Y14:RAMB18_X1Y19}
resize_pblock [get_pblocks pblock_RECONFIG_LEDS] -add {RAMB36_X1Y7:RAMB36_X1Y9}
